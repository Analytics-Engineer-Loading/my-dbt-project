...
, total_monthly_user_from_jawa_timur AS (
    ...
    WHERE
        user.customer_state = 'JAWA TIMUR'
    GROUP BY
        order_month
)
...
LEFT JOIN
    total_monthly_user_from_jawa_timur AS jt
        ON jt.order_month = u.order_month
LEFT JOIN
    monthly_orders_recap AS o
        ON o.order_month = u.order_month
ORDER BY
    order_month